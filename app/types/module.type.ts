...
export interface ModuleInterface {
	 ...
	 * Set text
	 *
	 * @interface [ModuleInterface](https://github.com/ptkdev-boilerplate/node-cli-boilerplate/blob/main/app/types/module.type.ts)
	 *
...
export interface ModuleResponseInterface {
	 ...
	 * Get text
	 *
	  * @interface [ModuleResponseInterface](https://github.com/ptkdev-boilerplate/node-cli-boilerplate/blob/main/app/types/module.type.ts)
	 *
